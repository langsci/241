...
\loupe{Arbre de dépendance}{
    ...
    [aimeraient
        [beaucoup,edge label={node[midway,left,font=\normalfont\scriptsize]{sujet}}
          [de,edge label={node[midway,left,font=\normalfont\scriptsize]{complément}}
            [gens,tier=word,edge label={node[midway,left,font=\normalfont\scriptsize]{complément}}]
          ]
        ]
        [passer,edge label={node[midway,right,font=\normalfont\scriptsize]{objet}}
          [Noël,edge label={node[midway,left,font=\normalfont\scriptsize]{objet}}] 
          [en,edge label={node[midway,right,font=\normalfont\scriptsize]{locatif}}
...
\includegraphics[height=5mm]{figures/gk-globe.pdf}
...
\includegraphics[height=5mm]{figures/gk-eiffel.pdf}
...
\lecturesadditionnelles{
    ...
    Haitao \citet{Liu2009} \textrm{依存语法的理论与实践 (}Théorie et pratique de la grammaire de dépendance).
