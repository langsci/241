...
La grammie qui marque la diathèse passive (en français, \textsc{être} + V\textsubscript{part-passé}) est appelée la \noterme{voix passive} ou plus simplement le \terme{passif}. Nous y reviendrons à la \sectref{sec:13-potentiel}. Le passif est en français une redistribution : le premier actant de la diathèse passive est le deuxième argument du verbe.
