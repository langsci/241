...
\begin{figure}
	\begin{subfigure}[h]{0.5\textwidth}
		\begin{tikzpicture}[>={Triangle[]},
			...
			\draw[-{Triangle[]}] (tenirlajambe) -- (prof) node[font=\footnotesize,midway,right] {2};
			...
			\draw[-{Triangle[]}] (singulier0) -- (heure) node[font=\footnotesize,midway,left] {1};
		\end{tikzpicture}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\caption{Structure syntaxique profonde}
	\end{subfigure}
\caption{Structures pour les fonctions lexicales de \REF{ex:peurbleue}\label{fig:peurbleue}}
\end{figure}
...
\begin{figure}
	...
	\end{subfigure}
\caption{Deux représentations pour la structure syntaxique profonde de \REF{ex:content}a \label{fig:content}}
\end{figure}
...
%Figure 33 
	...
	\begin{subfigure}[h]{\textwidth}
		...
		\caption{Structure syntaxique profonde}
	\end{subfigure}
\caption{Structures pour un vocatif}
\end{figure}
