...
\begin{tikzpicture}[>={Triangle[]},
	...
	\begin{scope}[nodes={CircleNode}]
		...
		\node (prop) [below right=of tenirlajambe,label=right:{`prop'}] {};
...
\begin{tikzpicture}[>={Triangle[]},
	...
	\draw[-{Triangle[]}] (zoe) -- (venir) node[font=\footnotesize,midway,above] {1};
...
\end{forest}
\caption{Structure syntaxique profonde de \REF{ex:Mars}\label{fig:13-Mars}}
\end{figure}
...
\adjustbox{valign=t}{\begin{tikzpicture}[framed,
		...
		\begin{scope}[nodes={DiamondNode},node distance=0.1cm and 0.1cm]
			\node (nil) [below right=of prof] {};
		\end{scope}
		
		\gkcaption{\textsc{prof}}
		
\end{tikzpicture}}%
\hspace{0.3cm}\adjustbox{raise=-1cm}{$\bigoplus$}\hspace{0.3cm}%
\adjustbox{valign=t}{\begin{tikzpicture}[framed,
		label distance=0pt,
		node distance=1cm and 1cm,
		every label/.style={reset shape}]
		...
		\draw (A) -- (le) node[font=\footnotesize,midway,left] {det};
...
\begin{tikzpicture}[framed,
	...
	\begin{scope}[nodes={CircleNode}]
		...
		\node (B) [below right=of avoir,label=below right:{[1:V]}] {};
	\end{scope}
	
	\begin{scope}[nodes={DiamondNode},node distance=0.1cm and 0.1cm]
		\node (indpres) [fill,right=of avoir,label=right:{ind.prés}] {};
		\node (partpasse) [fill,above right=of B,label=right:{part-passé}] {};
	\end{scope}
...
\begin{tikzpicture}[framed,
	...
	\draw (A) -- (un) node[font=\footnotesize,midway,left] {det};
...
\begin{tikzpicture}[framed,
	...
	\draw (pendant) -- (B) node[font=\footnotesize,midway,right] {comp};
...
\begin{tikzpicture}[label distance=0pt,
	...
	\begin{scope}[nodes={DiamondNode},node distance=0.1cm and 0.1cm]
		\node (indpres) [fill,right=of avoir,label=right:{ind.prés}] {};
		\node (partpasse) [fill,below right=of tenir,label=right:{part-passé}] {};
