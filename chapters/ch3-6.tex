...
\begin{figure}
	\begin{subfigure}[h]{0.5\textwidth}
		...
		\end{tikzpicture}
		\caption{Structure sémantique}\todo[inline]{put figure a on the left (its caption is to close from figure c)}
	\end{subfigure}%
	\bigskip\\%
...
\begin{figure}
	...
	\end{subfigure}
\caption{Deux représentations pour la structure syntaxique profonde de \REF{ex:content}a \label{fig:content} avec une copule}
\end{figure}
...
% Figure 14
	...
	\begin{subfigure}[b]{0.5\textwidth}
		...
		\begin{forest} for tree={font=\normalfont}
			[\textsc{excellent}
				[dislocation(\textsc{café}\textsubscript{sg}),edge label={node[midway,left,font=\footnotesize]{1}}
...
%FIGURE 32
	...
	\begin{subfigure}[h]{\textwidth}
		...
		\end{tikzpicture}
		\caption{Structure sémantique}\todo[inline]{the caption of subfigure a is closer to subfig b than subfig a. This a general problem of subfigures  below each other, increased here by the asymetry of subfig a and the space above the caption}
	\end{subfigure}%
	\bigskip\\%
...
\begin{exe}
\exi{} \textit{Il caffe non mi fa dormire.}\\
