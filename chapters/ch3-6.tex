...
\end{tikzpicture}
\caption{Structure sémantique avec un cycle commune à \REF{ex:13-pronom}a et b \label{fig:13-pronom-sem}}
\end{figure}
...
\end{forest}
\caption{Structure syntaxique profonde pour la dislocation de \REF{ex:13-disloc}\label{fig:13-disloc}}
\end{figure}
