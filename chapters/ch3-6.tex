...
\begin{figure}
	\begin{subfigure}[h]{0.5\textwidth}
		...
		\todo[inline]{one element is missing in this figure: a node with a label passé (without quotes) and an arrow from this node to the node ’tenir la jambe’ with the value 1} 
	\end{subfigure}%
	\bigskip\medskip\\%
...
\todo[inline]{put the figure before this point}
\begin{figure}
	\begin{flushleft}
