...
\loupe{Binarité, construction et connexion}{%\label{sec:3.4.18}
    ...
    Trois représentations de la construction subjectale\smallskip\\
    \begin{minipage}[c]{.3\linewidth}\centering
      ...
      \end{tikzpicture}
    \end{minipage}\begin{minipage}[c]{.3\linewidth}\centering
      \begin{forest}
    ...
    \ea
    %%[Warning: Draw object ignored]
    Deux représentations des constructions subjectale et objectale\smallskip\\
    \begin{minipage}[c]{.3\linewidth}\centering
     \begin{forest} for tree = {font=\normalfont}
       [S [NP] [VP [V] [NP]]]
     \end{forest}
