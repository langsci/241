...
\ea Beaucoup de gens aimeraient passer Noël en Laponie. \z
...
\node at (0,0) [ConcSet,font=\small] (A) {beaucoup de gens};
\node [ConcSet,right=.5cm of A,font=\small] (B) {aimeraient};
\node [ConcSet,right=.5cm of B,font=\small] (C) {passer Noël en Laponie};          
...
\Definition{\textstyleTermes{constituants majeurs}}
...
\medskip\\
\fbox{\begin{forest} for tree = {fill=black!20}
[aimeraient
  [beaucoup [de [gens]]]
  [passer
    [Noël]
...
\loupe{Les limites des méthodes par décomposition}{%\label{sec:3.4.9}
    ...
    \ea
    Arbre de constituants binaire avec têtes et arbre de dépendance correspondant\smallskip\\
    ...
    \ea
    Une autre fragmentation et l’arbre de dépendance correspondant\smallskip\\
    \begin{minipage}[c]{.5\linewidth}\centering
    \begin{tikzpicture}[every node/.style={font=\strut}]
    \begin{scope}[
    every node/.style={circle,fill=black},
...
\ea \textbf{{Fred}}  {va chez son neveu pour les vacances.}\\
...
\begin{description}
  ...
  \item[Interrogation :] \textbf{\textit{Qu’est} \textit{ce que}} \textit{beaucoup de gens aimeraient} ? \textit{Passer Noël en Laponie.}
  \item[Semi-clivage :] \textbf{\textit{Ce que}} \textit{beaucoup de gens aimeraient}\textbf{, \textit{c’est}} \textit{passer Noël en Laponie.}
\end{description}
...
\begin{description}
\item[Pronom personnel :] \textit{Il y} \textbf{\textit{en}} \textit{a} \textbf{\textit{beaucoup}} \textit{qui aimeraient passer Noël en Laponie.}    
\end{description}
...
\Definition{\textstyleTermes{stratifié}, \textstyleTermes{stratification}}
...
\begin{forest} for tree={font=\itshape}
[aimeraient
  [beaucoup,edge label={node[near end,above] {2}}
    [de,edge label={node[midway,left] {1}}
        [gens,edge label={node[midway,left] {1}}]
    ]
  ]
  [passer,edge label={node[near end,above] {1}}
    [Noël,edge label={node[near end,above] {1}}] 
    [en,edge label={node[near end,above] {2}} 
        [Laponie,edge label={node[midway,right] {1}}]
    ]
  ]
]
\end{forest}
...
[aimeraient,name=aimeraient
  [beaucoup,no edge,name=beaucoup,edge label={node[near end,above] {2}}
    [de,no edge,name=de,edge label={node[midway,left] {1}}
        [gens,name=gens,edge label={node[midway,left] {1}}]
    ]
  ]
  [passer,no edge,name=passer,edge label={node[midway,above] {1}}
    [Noël,name=Noel,edge label={node[near end,above] {1}}] 
    [en,name=en,edge label={node[near end,above] {2}} 
        [Laponie,name=Laponie,edge label={node[midway,right] {1}}]
    ]
  ]
]
\begin{scope}[every node/.style={draw,rounded corners=2pt}]
...
\chevalier{Historique des représentations syntaxiques par des diagrammes en constituants}{%\label{sec:3.4.17}
    ...
    \ex Construction dans un arbre de constituants avec tête\smallskip\\
        \begin{tikzpicture}
        \node [circle,fill=black] (root) {}
            child { node [circle,fill=black] {} edge from parent node [near end,above] {T} }
...
\loupe{Binarité, construction et connexion}{%\label{sec:3.4.18}
    ...
    \begin{minipage}[c]{.3\linewidth}\centering
      \begin{tikzpicture} 
        \node [circle,draw,label=below:N] at (0,0) (A) {};
        \node [circle,draw,label=below:V] at (2,0) (B) {};
    ...
    \begin{tikzpicture}
      \node at (0,0) [circle,draw,label=below:N] (A) {};
      \node at (2,0) [circle,draw,label=below:V] (B) {};
      \node at (4,0) [circle,draw,label=below:N] (C) {};
...
\begin{tikzpicture}
  \node at (0,0) (A)  [circle,fill=black,label=below:A] {};
  \node at (2,0) (B)  [circle,fill=black,label=below:B] {};
  \node at (1,1) (U) [circle,fill=black,label=above:U] {};
  
  \draw (A) -- node [midway,above] {T} (U)
            -- (B);

 \node at (3,0.5) {⇔}; 
 \node at (4,0) (A2)  [circle,fill=black,label=below:A] {};
 \node at (6,0) (B2)  [circle,fill=black,label=below:B] {};
...
\begin{forest} nice empty nodes, for tree={font=\itshape}
[aimeraient
    [ 
        [ [beaucoup] [ [gens] [de] ] ] 
        [ [ [passer] [Noël] ] [ [en] [Laponie] ] ]
