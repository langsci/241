...
\maths[sec:1.2.3]{Graphe et arbre}{%
    ...
    Un graphe est dit \notextstyleTermes{acyclique}\is{acyclicité} s’il n’existe aucun chemin partant d’un nœud et revenant à ce nœud sans emprunter deux fois la même arête.
    ...
    Notons encore qu’il existe une notion d’acyclicité plus restrictive pour les graphes orientés : un graphe orienté est dit \notextstyleTermes{acyclique}\is{acyclicité} s’il n’existe aucun chemin orienté permettant de partir d’un nœud et, en se déplaçant de source en cible, de revenir au même nœud.
...
La structure que nous obtenons s’appelle un \notextstyleTermes{arbre de dépendance syntaxi\-que profond}\is{arbre syntaxique profond}
