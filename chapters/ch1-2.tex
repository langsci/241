...
\todo[inline]{add a big \Rightleftarrow between the two diagrams in both next figures}
...
\chevalier{D’où viennent les règles de la grammaire ?}{%\label{sec:1.2.15}
   ...
   \smallski\noindent \textbf{Quel est le bon français ?}
   ...
   \smallski\noindent \textbf{Quand les grammairiens ont gagné}
