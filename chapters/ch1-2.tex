...
\ea Description formelle d’un sens\\
\begin{center}
\textit{x} : ‘Ali’\\
...
\corrections{%\label{sec:1.2.19}
    ...
    \corrigé{2} Voir l'encadré \encadref{fig:1.2.6}.
