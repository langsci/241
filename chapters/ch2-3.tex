...
\Definition{\textstyleTermes{compositionnelle}}
...
\Definition{\textstyleTermes{transparente}}
...
\ea
  \ea {Pierre a pris un livre.} \textbf{{Il}}  {était sur la table.}
  \ex {Pierre a pris le livre} \textbf{{qui}}  {était sur la table.}
  \ex {Pierre est allé en vacances à la montagne.} \textbf{{Ca}} {lui a plu.}
  \z
\z
...
\ea
  \ea {Prends} \textbf{{ce livre}} !
  \ex {Pierre a pris un livre.} \textbf{{Ce livre}}  {était sur la table.}
  \ex {Pierre a fait le tour du monde.} \textbf{{Le voyage}}  {lui a plu.}
  \z
\z
...
\ea
  \ea {Do you plan to come with us?}\\
...
\Definition{\textstyleTermes{phrasème}, \textstyleTermes{locutions}, \textstyleTermes{expressions figées}, \textstyleTermes{expressions idiomatiques}}
...
\ea
\begin{tabularx}{\linewidth}[t]{@{}lllQ@{}}
a. & actif  &       {Marie gifle Pierre}     &  {Marie} \textbf{{donne}}  {une gifle à Pierre}\\
b. & passif avec agent & {Marie} \textbf{{est}}  {gifl}\textbf{{ée}}  {par Pierre}   &  {Marie} \textbf{{reçoit}}  {une gifle de Pierre}\\
c. & passif sans agent & {Marie} \textbf{{se fait}}  {gifl}\textbf{{er}}  &   {Marie} \textbf{{se}} \textbf{{prend}}  {une gifle}
\end{tabularx}
\z
...
\Definition{\textstyleTermes{semi-phrasème}}
...
\Definition{\textstyleTermes{semi-figée}}
...
Le \tabref{tab:2-3:1} suivant met en parallèle les choix contraints par \textsc{peur} et \textsc{colère} pour l’expression d’un certain nombre de sens très généraux comme ‘causer’, ‘commencer’ ou ‘intense’. (Une case vide indique l’absence de collocatif pour exprimer ce sens avec cette lexie.)
...
\z
\ex
\ea[\textsuperscript{??}]{Il a une belle peur des araignées.}
\ex[\textsuperscript{??}]{Tu m’as fais une peur bleue. Je ne t’avais pas vu.}
\z
\z
...
\Definition{\textstyleTermes{acceptions}}
...
\lecturesadditionnelles{%\label{sec:2.3.21}
    Le \textbf{sémantème}, appelé \textit{monème} par André Martinet, est défini dans ses \textit{Éléments de linguistique générale}, dont on consultera les sections 1 à 19 du chapitre 1 et le chapitre 4. Les notions introduites par Martinet sont également présentées dans \citet{costaouec2007syntaxe}. Le chapitre sur \textit{Les unités significatives} de l’encyclopédie de \citet{ducrot1995nouveau} complètera cette lecture.

    La syntaxe des \textbf{locutions} est étudiée en détail dans la thèse de Marie-Sophie \citet{pause2017structure}. La distinction entre \textbf{transparence} et \textbf{diagrammaticité} (appelée \textit{analycité}) est bien dégagée dans l’article de Marie Helena \citet{svensson2008very}.

    Le \textbf{découpage paradigmatique} en unités lexicales ainsi que les \textbf{collocations} sont très bien présentés dans \citet{polguere2003lexicologie}. Voir également \citet{melcuk1995introduction} pour une introduction plus technique aux \textbf{fonctions lexicales}, ainsi que \citet{melcuk2007lexique} pour des exemples d’entrées lexicales avec leurs collocatifs. Les \textbf{collocations morphologiques} sont présentées dans \citet{beck2019phraseology}.

    La notion de \textbf{faisceau de signes} est introduite dans le premier tome du \textit{Cours de Morphologie Générale} de \citet[278]{melcuk1993cours} (voir \chapref{sec:2.1}) dans la description des grammèmes, sans être exploitée pour les syntaxèmes en général.
