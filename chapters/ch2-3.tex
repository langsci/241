...
\ea 
  ...
  \glt   ‘Oui, je le prévois’, lit. ‘Oui, je fais’.
  \z
\z
}
...
\end{figure}
\todo[inline]{In the 6 figures, the "…" should be closer to 'FUTUR' and the figure centered in the page on ALLER if possible}
