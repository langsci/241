...
Prenons l’exemple de l’énoncé \textit{Pierre mange une pomme de terre}. Dans cet énoncé, les mots \textit{pomme}, \textit{de} et \textit{terre} sont des signes linguistiques, mais aucun d’eux ne résulte d’un choix propre.
...
\loupe[sec:2.3.9]{Verbes supports et unités grammaticales}{%
    ...
    Par exemple, pour exprimer le sens ‘gifler’, on a le choix entre le verbe \textsc{gifler} et une construction à verbe support avec le nom \textsc{gifle}. Dans les deux cas, trois diathèses sont possibles (la notion de \textit{diathèse} sera étudiée à la \sectref{sec:13-actant} sur \textit{Argument, actant et modifieur}) :
