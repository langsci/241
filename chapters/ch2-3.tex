...
\todo[online]{déviss(er)1 and déviss(er)2 must be in the same box}
\end{figure}
...
\end{figure}
\todo[online]{In the 6 figures, the "…" should be closer to 'FUTUR' and the figure centered in the page on ALLER if possible}
