...
\maths{Dualité}{%\label{sec:2.2.8}
    ...
    \begin{tikzpicture}[3d view={45}{45}]
    \begin{scope}[canvas is xy plane at z=0,transform shape]
        \draw (0,0) circle [radius=2cm] coordinate (circle1);
        \node (classe) [draw,circle] at (-.5,0) {classe (A)};
        \node (B) [draw,circle] at (1,0) {B};
        \node[left=2cm of circle1] {objets};
        \node[right=2cm of circle1] {signes};
    \end{scope}
    \begin{scope}[canvas is xy plane at z=-5.5,transform shape]
