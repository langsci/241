...
\lecturesadditionnelles{%\label{sec:1.1.14}
    ...
    Leonard \citet{bloomfield1933language} \textit{Language}, New York (traduction française : \textit{Le langage}, Payot, 1970).

    Noam \citet{chomsky1955three} \textit{The minimalist program}, MIT Press.
    ...
    Ferdinand de \citet{saussure1916cours} \textit{Cours de linguistique générale}, Paris.
