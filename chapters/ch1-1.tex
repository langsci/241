...
\todo[online]{adjust the space in S → r -- s → R, all spaces between the two symbols -> and -- dans the four letters must be equal.}
\end{itemize}
...
et je voulais pas aller à AA puisque  & \textbf{les}\\
    ...
    \end{tabularx}
\z
\todo[online]{"les grandes villes" must be on one line. It seems there enough place for that}
...
\multicolumn{1}{@{}l|}{} &                & \textbf{ou le Méridional}\\
\multicolumn{1}{@{}l|}{} & \multicolumn{1}{l}{} & \multicolumn{1}{l@{}}{}\\
...
\end{tabular}
\z
\todo[online]{The "box" containing le Provençal ou le Méridonial should follow directly je crois que c’était. It must not be aligned with the other "box". I know it is easy to do that with a tabular, but it is important to avoid misinterpretations. }
