...
\ea \begin{tabular}[t]{@{}|p{1cm}ll@{}}
    \multicolumn{3}{l}{donc pour essayer un petit peu de sortir cette personne de la misère}\\
    \multicolumn{1}{c}{}& \multicolumn{2}{>{\hangindent=1em}p{.75\textwidth}}{(car c’est vraiment un petit peu semblable aux Misérables de Victor-Hugo)}\\
...
\citations{%\label{sec:1.1.15}
    ...
    \textbf{\citet{bloomfield1933language}~}:
    ...
    \textbf{\citet{gleason1955introduction}~}:
