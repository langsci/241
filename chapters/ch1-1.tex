...
\pagebreak\section{Langue, linguistique et modélisation}\label{sec:1.1.7}
...
\z
% \todo[inline]{The "box" containing le Provençal ou le Méridonial should follow directly je crois que c’était. It must not be aligned with the other "box". I know it is easy to do that with a tabular, but it is important to avoid misinterpretations. }
...
\corrections{%\label{sec:1.1.16}
    ...
    \corrigé{2} Non, \textsuperscript{?}* signifie qu’on n’est pas complètement sûr que la phrase soit grammaticale. Voir \sectref{sec:1.1.11}.
