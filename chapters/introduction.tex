...
\eiffel{Le lexique : un cabinet de curiosités}{
   ...
   \ea
   \ea[*]{\textbf{{Il y a}} {à un endroit} \textbf{{qu’}}{on les trouve.}}
   \ex[*]{\textbf{{Il y a}} {à quelqu’un} \textbf{{que}} {je pense.}}
   \z
   \z
   ...
   \ea
   \ea[]{\textbf{{Ça} {fait}} {une semaine} \textbf{{qu’}}{on ne s’est} {pas vu.}}
   \ex[*]{\textbf{{Ça} {fait}} {des choses} \textbf{{que}} {j’ai} {achetées là-bas.}}
   \z
   \z
...
\corrections{
    ...
    \corrigé{3} Toutes ces notions seront étudiées en détail dans cet ouvrage. Mais il peut être bon de fixer les termes dès maintenant. La topologie est l’étude de l’interface entre syntaxe et ordre linéaire des mots. L’interface sémantique-syntaxe est, comme son nom l’indique l’étude de la correspondance entre sémantique et syntaxe. La nanosyntaxe est la partie de la syntaxe qui s’intéresse aux combinaisons d’unités linguistiques les plus cohésives, celles de l’ordre du mot. Voir les Sections~\ref{sec:0.0.8}--\ref{sec:0.0.11}.
