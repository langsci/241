...
\exercices{
    ...
    \item \itshape Il ne parle pas vraiment le swahili, parce qu’il ne connaît que quelques mots, et il ne connaît pas du tout la grammaire.
    \item \itshape Ça ne se dit pas comme ça, j’ai regardé dans une grammaire.
    \item \itshape Les grammaires de dépendance proposent un formalisme pour représenter les relations qu’entretiennent les mots entre eux.
    \item \itshape C’est incroyable comment un bébé apprend vite la grammaire.
    \item \itshape C’est parce que la grammaire est innée.
    \item \itshape La grammaire française ne permet l’inversion du sujet que dans des cas très restreints.
    \item \itshape On vous enseigne de ne plus faire de fautes de grammaire.
    \item \itshape Les composants fondamentaux des systèmes d’information géographique se conjuguent dans une sorte de grammaire des formes géographiques.
    \item \itshape Le cinéma n’est pas une langue dont il suffirait d’apprendre la grammaire et le vocabulaire.
    \item \itshape La seule grande grammaire italienne disponible en français, celle de Jacqueline Brunet, est à juste titre descriptive (et non normative).
    \item \itshape Après tout, la rigueur de la pensée, on l’apprend avec la grammaire, la philosophie …
    \end{enumerate}

    \item Distinguer les emplois du mot \textit{syntaxe} dans les phrases suivantes :

    \begin{enumerate}[label=(\arabic*),resume]
    \item \itshape Chaque moteur de recherche a sa propre syntaxe.
    \item \itshape Dans chacun des domaines de la linguistique (syntaxe, phonologie, morphologie et sémantique lexicale), nos connaissances ne sont ni apprises ni données.
    \item \itshape Françoise Morvan s’efforce d’inventer une syntaxe française avec parfois des tournures bretonnes.
    \item \itshape J’ai déjà eu l’occasion d’attirer l’attention sur la multiplicité des coquilles, fautes de syntaxe, fautes d’orthographe que l’on trouve dans ce journal.
    \item \itshape Les rédacteurs du Nouvelliste ne maîtrisent qu’approximativement le français, ils se perdent dans la logique de la syntaxe et se noient dans l’abus de vocabulaire.
    \item \itshape J’ai essayé de trouver la bonne syntaxe pour le film.
    \item \itshape Du point de vue de la syntaxe, certaines évolutions sont visibles et prévisibles. Ainsi, le remplacement de "nous" par "on" avec un pluriel. "Mon fils et moi, on est allés au cinéma".
    \item \itshape Envoyez un SMS selon la syntaxe suivante : le mot-clé ‘METEO’ ‘espace’ puis le numéro du département dont vous souhaitez connaître la météo.
    \end{enumerate}
    \end{enumerate}
 }
