...
\draw[ConversionArrow, thick] (3.5,0) -- (4.5,0);
\node at (5,0) (X) {X};
\node at (6,0) (A) {A};
\node at (7,0) (B) {B};
...
\begin{enumerate}
    ...
    \ea
      \ea Peter slept.    ‘Pierre a dormi.’
      \ex \textbf{{Did}}  {Peter sleep?}    ‘Pierre a-t-il dormi ?’
      \ex {Peter} \textbf{{didn’t}}  {sleep.}  ‘Pierre n’a pas dormi.’
      \z
    \z
