...
\end{minipage}
\end{figure}
\todo[inline]{the figures are too large. You can bring closer to the buble the label U, U' and U''. You can also keep the figure in the center on top and slightly slid down the two figures from the sides}
