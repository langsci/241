...
%                                        %
    ...
    \corrigé{4} Le critère 1 de Paul Garde vise le critère distributionnel avec effacement positif : si AB et B ont la même distribution, alors B est la tête.
    ...
    \end{enumerate}
    Le critère distributionnel avec effacement négatif n’est pas énoncé. Cela donnerait dans le style de Garde : dans un contexte donné, X(A), mais non *X(AB). 
    ...
    \begin{enumerate}[label=2a.] \item    pour tout A’, pour tout X, X (AB) → X (A’B).\end{enumerate}
    ...
    \begin{enumerate}[label=2b.] \item  il existe B’ et X tels que X (AB) et *X (AB’). \end{enumerate}
    ...
    Le critères 2 et 3 visent bien à dire que B contrôle la distribution de AB, c’est-à-dire qu’il existe un B’ tel que AB et AB’ aient des distributions différentes. Les deux critères sont très similaires : le critère 2a dit que la distribution de AB est incluse dans celle de n’importe quel A’B, tandis que le critère 3b dit que la distribution de n’importe quel A’B est incluse dans celle AB.
