...
qui est aussi appelée le \hi{Critère topologique pour l'identification de la tête}. Il existe d'autres critères topologiques, utilisés dans l'identification des connexions, comme le \hi{Critère de déplacement} (\sectref{sec:3.2.16} \textit{Tests pour la connexion}).
