...
{\textstyleTermes{Critère distributionnel avec effacement positif}. Si U = A ${\oplus}$ B, que A est autonomisable (et donc B est effaçable) et que A a la même \hi{valence supérieure} que U, alors A est un \hi{tête} de U.}
...
{\textstyleTermes{Critère distributionnel avec effacement négatif}. Si U = A ${\oplus}$ B, que A est autonomisable (et donc B est effaçable) et que A \textit{n'}a \textit{pas} la même \hi{valence supérieure} que U, alors B est un \hi{tête} de U.}
