...
\loupe{Les grammèmes comme tête}{%\label{sec:3.3.29}
    ...
    \end{forest}
    \z
    \todo[inline]{Add a \Longrightarrow between the two subfigures and move the right figure to the left.}
...
\todo[inline]{Same remarks: \Longrightarrow, move, darker}
...
Le critère de recouvrement, qui est basé sur des critères topologiques, est aussi appelée le critère topologique pour l'identification de la tête. Il existe d'autres critères topologiques utilisés dans l'identification des connexions, comme le critère de
déplacement
