...
\item le \hi{critère distributionnel avec effacement négatif}: un élément (éventuellement non autonomisable) de U si son effacement modifie la valence supérieure de U (\sectref{sec:3.3.11}).
