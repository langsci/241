...
% %     \includegraphics[width=7cm]{figures/ReedKellogTree}    
    ...
    \includegraphics[width=\textwidth]{figures/vol1syntaxe2-img017.png}\smallskip\\    
...
\begin{figure}[H]
    ...
    \label{fig:mesdeux3}
\todo[inline]{Same remarks: \textbackslash Longrightarrow, move}
\end{figure}
    \end{itemize}
}
...
\citations{%\label{sec:3.3.37}
    \noindent{\sffamily\bfseries Citations de l'\encadref{fig:3.3.2}}
    ...
    \noindent {\sffamily\bfseries Citations de l'\encadref{fig:3.3.5}}
