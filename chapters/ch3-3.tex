...
\lecturesadditionnelles{%\label{sec:3.3.36}
    ...
    Les actes de langage et la fonction illocutoire sont introduits dans les ouvrages de \citet{Gardiner1932}, \citet{bloomfield1933language}, \citet{Austin1962} et \citet{searle1969speech}.
    ...
    Leonard \citet{bloomfield1933language} \textit{Language}, New York, [traduction française, 1969, \textit{Le langage}, Paris : Payot].
    ...
    John \citet{searle1969speech} \textit{Speech Acts}, Cambridge University Press, [traduction française, 1969, \textit{Les actes de langage}, Hermann.

    Roch-Amboise \citet{sicard1801elemens} \textit{Élémens de grammaire générale appliqués à la langue française} (2 volumes), Paris : Deterville.

    Henry \citet{sweet1891new} \textit{A new English Grammar, logical and historical}, Oxford : Clarendon.
    ...
    Henri \citet{weil1844de} \textit{De l’ordre des mots dans les langues anciennes comparées aux langues modernes}, Paris: Crapelet.
