...
\corrections{%\label{sec:3.3.37}
    ...
    \begin{exe}
    Diagramme d’après \citet{buffier1709grammaire}\\
     ...
     [a coutume 
        [de causer
            [beaucoup d’ennui, edge label={%
                            node[near start,left=1em,font=\small\rmshape]{régime absolu}}]    
            [à tout le monde, edge label={%
                            node[near start,right=1em,font=\small\rmshape]{régime respectif}}]
        ]
     ]
    \end{forest}
    \end{exe}
