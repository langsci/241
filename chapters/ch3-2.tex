...
\Definition{\textstyleTermes{connexion syntaxique}}
{Une \textstyleTermes{connexion syntaxique} représente un \hi{ensemble de combinaisons syntaxiques équivalentes}. Il s’agit d’une «~abstraction~» de la notion de combinaison.}
