...
\lecturesadditionnelles{%\label{sec:3.2.28}
    ...
    Henri \citet{weil1844de} \textit{De l’ordre des mots dans les langues anciennes comparées aux langues modernes}, thèse de doctorat, Paris.
}
