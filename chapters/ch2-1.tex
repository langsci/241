...
\Definition{\color{red}Which title should we use ?}
...
\loupe{Le signe linguistique}{%\label{sec:2.1.4}
    La notion moderne de \textbf{signe linguistique} est généralement attribuée à \textcite[98]{saussure1916cours} :\todo[inline]{check "Saussure" against "de Saussure" in whole book}
