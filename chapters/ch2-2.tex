...
\exercices{%\label{sec:2.2.27}
    ...
    \end{enumerate}
     ...
     \exercice{12} Que peut-on dires des radicaux du verbe \textsc{avoir} au présent de l'indicatif ? On pourra en particulier comparer la conjugaison de ce verbe à celui de \textsc{aller}, ainsi qu'aux formes du futur de l'ensemble des verbes du français.
}
