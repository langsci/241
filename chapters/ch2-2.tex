...
{Un \hi{signe linguistique} qui \hi{commute librement} avec son environnement est appelé une \textstyleTermes{unité syntaxique}. (Voir \chapref{sec:3.1} pour une définition plus précise.)}
...
Les syntaxèmes zéros appartiennent généralement à un \textstyleTermes{paradigme fermé}, condition propice à ce que \hi{l’absence} \hi{soit signifiante}. Ce sont donc essentiellement des \hi{syntaxèmes flexionnels}. (Voir un contre-exemple dans l'Exercice 12.)
