...
\todo[inline]{The term ``Définition'' is a fixed lay out element and the title can't be changed unfortunately. Could you include the information that this is a definition of a notation in the title? Alternatively, we could use a yellow highlight box.}
...
Les syntaxèmes zéros appartiennent généralement à un \textbf{paradigme fermé}, condition propice à ce que \textbf{l’absence} \textbf{soit signifiante}. Ce sont donc essentiellement des \textbf{syntaxèmes flexionnels}. (Voir un contre-exemple dans la section \sectref{sec:2.2.27} des \textit{Exercices}.)
...
\exercices{%\label{sec:2.2.27}
    ...
    \end{enumerate}
     ...
     \exercice{12} Que peut-on dire des radicaux du verbe \textsc{avoir} au présent de l'indicatif ? On pourra en particulier comparer la conjugaison de ce verbe à celui de \textsc{aller}, ainsi qu'aux formes du futur de l'ensemble des verbes du français.
}
