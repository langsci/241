...
Les syntaxèmes zéros appartiennent généralement à un \textstyleTermes{paradigme fermé}, condition propice à ce que \hi{l’absence} \hi{soit signifiante}. Ce sont donc essentiellement des \hi{syntaxèmes flexionnels}. (Voir un contre-exemple dans l'exercice 12 en fin de chapitre.)
...
\corrections{%\label{sec:2.2.29}
    ...
    \corrigé{8} Le radical du verbe \textsc{définir} est \textit{définiss-} /definis/, donc le suffixe de \textit{définition} est \textit{{}-ion} /jɔ/. Le suffixe est le même dans \textit{compression}. Par contre, le suffixe de \textit{constitution} est \textit{{}-tion} /sjɔ/, puisque le radical du verbe \textsc{constituer} est \textit{constitu-}.
