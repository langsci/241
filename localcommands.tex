...
\newcommand{\corrections}[1]{\begin{tblsfilledsymbol}{Corrections des exercices}{hamac}#1\end{tblsfilledsymbol}}
...
\newcommand{\exercices}[1]{\begin{tblsfilledsymbol}{Exercices}{halteres}#1\end{tblsfilledsymbol}}
