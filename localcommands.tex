...
\newcommand{\chapffuturef}[1]{#1}
\let\chapfuref\chapffuturef
\let\chafuturef\chapffuturef
...
\renewcommand{\loupe}[2]{\gkboxsection{tbls-loupe}{#1}{#2}}
...
\renewcommand{\loupe}[2]{\begin{encadre}{#1}{loupe}#2\end{encadre}}
\renewcommand{\eiffel}[2]{\begin{encadre}{#1}{eiffel}#2\end{encadre}}
\renewcommand{\globe}[2]{\begin{encadre}{#1}{world}#2\end{encadre}}
\renewcommand{\chevalier}[2]{\begin{encadre}{#1}{history}#2\end{encadre}}
\renewcommand{\maths}[2]{\begin{encadre}{#1}{math}#2\end{encadre}}
