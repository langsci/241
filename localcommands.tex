...
\mdfsetup{frametitlefont=\sffamily\bfseries}
\newcounter{ghdefinition}
\newcommand{\Definition}[2]{%
  \refstepcounter{ghdefinition}%
  \tblsfd{\lsSeriesColor}{.8}{\hspace*{-\parindent}#1\hfill Définition~\thechapter.\arabic{ghdefinition}}
  {#2}
}
...
\newcommand{\lecturesadditionnelles}[1]{\tblssy{book}{Lectures additionnelles}{#1}}
